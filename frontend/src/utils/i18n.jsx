...
const translations = {
  en: {
    ...
    'login.title': 'Salesforce Data Chat',
  ...
  te: {
    ...
    'login.title': 'Salesforce డేటా చాట్',
    ...
    'login.default': 'డిఫాల్ట్: admin / admin123',
    'actions.copy': 'కాపీ',
