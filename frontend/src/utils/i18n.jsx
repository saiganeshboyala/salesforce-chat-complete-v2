...
const translations = {
  en: {
    ...
    'chat.welcomeSub': 'Ask anything about your data. Real-time queries, instant answers.',
  ...
  hi: {
    ...
    'chat.placeholder': 'अपने डेटा के बारे में पूछें...',
    'chat.placeholderFile': '{file} के बारे में पूछें...',
    'chat.welcome': 'स्वागत है, {name}',
    'chat.welcomeSub': 'अपने डेटा के बारे में कुछ भी पूछें। रीयल-टाइम क्वेरी, त्वरित उत्तर।',
  ...
  te: {
    ...
    'chat.placeholder': 'మీ డేటా గురించి అడగండి...',
    'chat.placeholderFile': '{file} గురించి అడగండి...',
    'chat.welcome': 'స్వాగతం, {name}',
    'chat.welcomeSub': 'మీ డేటా గురించి ఏదైనా అడగండి. రియల్-టైమ్ ప్రశ్నలు, తక్షణ సమాధానాలు.',
